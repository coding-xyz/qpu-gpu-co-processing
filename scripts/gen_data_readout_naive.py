...
def main():
    ...
    ap.add_argument("--out_npz", type=str, default="test_dataset.npz")
    ...
    np.savez_compressed(args.out_npz, X_train=X_train, y_train=y_train, X_test=X_test, y_test=y_test,
                        meta=json.dumps(meta))
    print(f"saved: {args.out_npz}  train={X_train.shape} test={X_test.shape}")
